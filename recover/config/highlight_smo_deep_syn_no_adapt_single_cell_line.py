...
from recover.models.predictors import BilinearFilmMLPPredictor, AdvancedBayesianBilinearMLPPredictor,\
    BilinearMLPPredictor, BilinearFilmWithFeatMLPPredictor, DeepSynergyPredictor
...
model_config = {
    ...
    "model_weights_file": os.path.join(get_project_root(), "RayLogs", "pretrain_ONEIL_deep_syn",
                                       "BasicTrainer_772e3_00000",
                                       "checkpoint_000043", "model.pth"),
}
...
dataset_config = {
    ...
    "rounds_to_include": [],
    "cell_line": tune.grid_search(['HCT116', 'HT29', 'NCI-H460', 'NCIH23', 'OVCAR3',
                                   'SK-OV-3', 'SW-620', 'T-47D', 'UACC62']),  # Restrict to a specific cell line
    "val_set_prop": 0.1,
    "test_set_prop": 0.,
...
active_learning_config = {
    "ensemble_size": 5,
    "acquisition": GreedyAcquisition,  # tune.grid_search([GreedyAcquisition, UCB, RandomAcquisition]),
    "patience_max": 4,
    "kappa": 1,
    "kappa_decrease_factor": 1,
    "n_epoch_between_queries": 500,
    "acquire_n_at_a_time": 300,
    "n_initial": 0,
}
...
configuration = {
    ...
    "memory": 3000,
    "stop": {"training_iteration": 1, 'all_space_explored': 1},

...
from recover.models.predictors import BayesianShuffledBilinearFilmMLPPredictor, BayesianBilinearMLPPredictor #adding Bayesian predictor
...
predictor_config = {
    "predictor": BayesianShuffledBilinearFilmMLPPredictor, #BayesianShuffledBilinearFilmMLPPredictor
    "predictor_layers":
        [
            2048,
            128,

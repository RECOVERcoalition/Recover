...
from recover.models.predictors import BayesianBilinearFilmMLPPredictor, BayesianLinFilmWithFeatMLPPredictor #adding Bayesian predictor
...
predictor_config = {
    "predictor": BayesianLinFilmWithFeatMLPPredictor, #BayesianLinFilmWithFeatMLPPredictor
    "predictor_layers":
        [
            2048,
            128,

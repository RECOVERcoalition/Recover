...
from recover.models.predictors import BayesianBilinearFilmMLPPredictor, BayesianShuffledBilinearLinFilmWithFeatMLPPredictor #adding Bayesian predictor
...
predictor_config = {
    "predictor": BayesianShuffledBilinearLinFilmWithFeatMLPPredictor,
    "predictor_layers":
        [
            2048,
            128,

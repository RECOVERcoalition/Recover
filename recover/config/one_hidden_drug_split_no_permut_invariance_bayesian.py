...
from recover.models.predictors import BilinearFilmMLPPredictor, BayesianBilinearMLPPredictor, BayesianMLPPredictor #adding Bayesian predictor
...
predictor_config = {
    "predictor": BayesianMLPPredictor, #BayesianMLPPredictor
    "predictor_layers":
        [
            2048,
            128,

...
from recover.models.predictors import BayesianBilinearFilmMLPPredictor, BayesianBilinearMLPPredictor, BayesianFilmMLPPredictor #adding Bayesian predictor
...
predictor_config = {
    "predictor": BayesianFilmMLPPredictor, #BayesianFilmMLPPredictor
    "predictor_layers":
        [
            2048,
            128,
    ...
    "stop": {"training_iteration": 5, 'patience': 10} #in order to check when the training in over, we parse these arguments
}
...
configuration = {
    ...
    "memory": 1800,
    "stop": {"training_iteration": 5, 'patience': 10},

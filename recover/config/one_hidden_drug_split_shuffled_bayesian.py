...
from recover.models.predictors import BilinearFilmMLPPredictor, BayesianBilinearMLPPredictor, BayesianShuffledBilinearMLPPredictor #adding Bayesian predictor
...
predictor_config = {
    "predictor": BayesianShuffledBilinearMLPPredictor, #BayesianShuffledBilinearMLPPredictor
    "predictor_layers":
        [
            2048,
            128,

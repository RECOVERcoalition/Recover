...
from recover.models.predictors import BayesianBilinearFilmMLPPredictor, BayesianBilinearMLPPredictor #adding Bayesian predictor
...
predictor_config = {
    "predictor": BayesianBilinearFilmMLPPredictor, #BayesianBilinearFilmMLPPredictor
    "predictor_layers":
        [
            2048,
            128,
